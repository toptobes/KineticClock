...
@Composable
fun AlphaMulti(enabled: Boolean) {
    ...
    if (enabled && yOffset > -50) SettingsText.text = String.format("%.2fx", Settings.alphaMulti)
    ...
    Column(
        ...
        Slider(
            ...
            value = com.clock.szttings.Settings.alphaMulti,
            onValueChange = {
                com.clock.szttings.Settings.alphaMulti = it
            },
            valueRange = .01f..1f,
